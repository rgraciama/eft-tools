                    ...
                    <div className="Hideout__row">
                        <div className="Hideout__pluses">
                            <div className="Hideout__item-recipe">
                                ...
                                <div className="Hideout__price" name="analgin_painkillers"/>
                            </div>
                            ...
                            <div className="Hideout__item-recipe">
                                <img alt="EFT Aseptic-Bandage Icon.png"
                                     ...
                                     decoding="async" width="64" height="64"/>
                                <div className="Hideout__price" name="aseptic_bandage"/>
                            </div>
                            <div className="Hideout__plus"/>
                            <div className="Hideout__item-recipe">
                                <img className="Hideout__element" alt="EFT Splint Icon.png"
                                     ...
                                     decoding="async" width="64" height="64"/>
                                <div className="Hideout__price" name="immobilizing_splint"/>
                            </div>
                          <div className="Hideout__sum"></div>
                        </div>
